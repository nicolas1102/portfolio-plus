...
export default function ProjectItem({ year, title, duration, details }) {
  return (
    <ol className="group flex flex-col md:flex-row relative border-l-2 border-secondary-500 dark:border-white">
      <div className="border-2 ml-4 mb-4 p-2 border-secondary-500 dark:border-white shadow-md3 hover:shadow-md3-hover dark:shadow-md3-dk dark:hover:shadow-md3-hover-dk transition duration-500">
        <li className="mb-5">
          ...
          <div className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
            <span className="inline-block px-2 py-1 font-semibold text-white dark:text-secondary-500 bg-secondary-500 dark:bg-white rounded-md group-hover:bg-primary-200 dark:group-hover:bg-primary-300 transition duration-500">
              {year}
            </span>
